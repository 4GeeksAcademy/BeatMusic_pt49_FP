                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-2 co-lg-2 d-flex align-self-center justify-content-evenly">
                                            {favorites.includes(item.name) ?
                                                <button onClick={() => { actions.deleteFavoriteArtist(item.id) }} className="btn text-white btn-green">Delete Favorite</button> :
                                                <button onClick={() => { actions.addFavoriteArtist(item.id) }} className="btn text-white btn-pink">Add to Favorites</button>
											}
                                        </div>
                                    </div>
                                </li>
